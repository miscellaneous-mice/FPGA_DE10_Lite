...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../signal_analyzer.sopcinfo
...
# Design Name 
# setting SOPC_NAME is signal_analyzer
SOPC_NAME := signal_analyzer
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x4001838
SOPC_SYSID_FLAG += --sidp=0x4001838
ELF_PATCH_FLAG  += --sidp 0x4001838

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1773525975
SOPC_SYSID_FLAG += --timestamp=1773525975
ELF_PATCH_FLAG  += --timestamp 1773525975
