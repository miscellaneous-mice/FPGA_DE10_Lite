...
$(MEM_0)_START := 0x04200000
$(MEM_0)_END := 0x0435ffff
$(MEM_0)_SPAN := 0x00160000
$(MEM_0)_HIERARCHICAL_PATH := FLASH_MEM
$(MEM_0)_WIDTH := 32
...
.PHONY: FLASH_MEM
FLASH_MEM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym $(MEM_0).flash
