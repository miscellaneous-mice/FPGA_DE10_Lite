	component signal_analyzer is
		port (
			...
			gpio_dma_interface_writebyteenable_n : in    std_logic_vector(35 downto 0) := (others => 'X'); -- writebyteenable_n
	...
	u0 : component signal_analyzer
		port map (
			...
			gpio_dma_interface_writebyteenable_n => CONNECTED_TO_gpio_dma_interface_writebyteenable_n, -- gpio_dma_interface.writebyteenable_n
