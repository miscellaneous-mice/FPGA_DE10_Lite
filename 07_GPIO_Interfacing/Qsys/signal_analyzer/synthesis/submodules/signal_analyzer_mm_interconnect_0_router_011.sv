...
module signal_analyzer_mm_interconnect_0_router_011_default_decode
  #(
  ...
  (output [202 - 199 : 0] default_destination_id,
...
module signal_analyzer_mm_interconnect_0_router_011
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    signal_analyzer_mm_interconnect_0_router_011_default_decode the_default_decode(
