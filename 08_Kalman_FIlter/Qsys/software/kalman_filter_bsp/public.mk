...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../kalman_interface.sopcinfo
...
# Design Name 
# setting SOPC_NAME is kalman_interface
SOPC_NAME := kalman_interface
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x8201088
SOPC_SYSID_FLAG += --sidp=0x8201088
ELF_PATCH_FLAG  += --sidp 0x8201088

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1779308355
SOPC_SYSID_FLAG += --timestamp=1779308355
ELF_PATCH_FLAG  += --timestamp 1779308355
