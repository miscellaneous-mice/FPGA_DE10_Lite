// kalman_interface_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module kalman_interface_mm_interconnect_0 (
		...
		input  wire [27:0] NIOS_data_master_address,                //                  NIOS_data_master.address
		...
		input  wire [27:0] NIOS_instruction_master_address,         //           NIOS_instruction_master.address
		...
		output wire [4:0]  KALMAN_s0_address,                       //                         KALMAN_s0.address
		output wire        KALMAN_s0_write,                         //                                  .write
		output wire        KALMAN_s0_read,                          //                                  .read
		input  wire [31:0] KALMAN_s0_readdata,                      //                                  .readdata
		output wire [31:0] KALMAN_s0_writedata,                     //                                  .writedata
	...
	wire   [27:0] nios_data_master_translator_avalon_universal_master_0_address;              // NIOS_data_master_translator:uav_address -> NIOS_data_master_agent:av_address
	...
	wire   [27:0] nios_instruction_master_translator_avalon_universal_master_0_address;       // NIOS_instruction_master_translator:uav_address -> NIOS_instruction_master_agent:av_address
	...
	wire    [6:0] cmd_mux_001_src_channel;                                                    // cmd_mux_001:src_channel -> SYS_ID_control_slave_agent:cp_channel
	...
	wire    [6:0] cmd_mux_002_src_channel;                                                    // cmd_mux_002:src_channel -> FLASH_MEM_csr_agent:cp_channel
	...
	wire    [6:0] cmd_mux_003_src_channel;                                                    // cmd_mux_003:src_channel -> FLASH_MEM_data_agent:cp_channel
	...
	wire   [27:0] nios_debug_mem_slave_agent_m0_address;                                      // NIOS_debug_mem_slave_agent:m0_address -> NIOS_debug_mem_slave_translator:uav_address
	...
	wire  [107:0] nios_debug_mem_slave_agent_rf_source_data;                                  // NIOS_debug_mem_slave_agent:rf_source_data -> NIOS_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [107:0] nios_debug_mem_slave_agent_rsp_fifo_out_data;                               // NIOS_debug_mem_slave_agent_rsp_fifo:out_data -> NIOS_debug_mem_slave_agent:rf_sink_data
	...
	wire  [106:0] cmd_mux_004_src_data;                                                       // cmd_mux_004:src_data -> NIOS_debug_mem_slave_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                      // NIOS_debug_mem_slave_agent:cp_ready -> cmd_mux_004:src_ready
	wire    [6:0] cmd_mux_004_src_channel;                                                    // cmd_mux_004:src_channel -> NIOS_debug_mem_slave_agent:cp_channel
	...
	wire   [31:0] kalman_s0_agent_m0_readdata;                                                // KALMAN_s0_translator:uav_readdata -> KALMAN_s0_agent:m0_readdata
	wire          kalman_s0_agent_m0_waitrequest;                                             // KALMAN_s0_translator:uav_waitrequest -> KALMAN_s0_agent:m0_waitrequest
	wire          kalman_s0_agent_m0_debugaccess;                                             // KALMAN_s0_agent:m0_debugaccess -> KALMAN_s0_translator:uav_debugaccess
	wire   [27:0] kalman_s0_agent_m0_address;                                                 // KALMAN_s0_agent:m0_address -> KALMAN_s0_translator:uav_address
	wire    [3:0] kalman_s0_agent_m0_byteenable;                                              // KALMAN_s0_agent:m0_byteenable -> KALMAN_s0_translator:uav_byteenable
	wire          kalman_s0_agent_m0_read;                                                    // KALMAN_s0_agent:m0_read -> KALMAN_s0_translator:uav_read
	wire          kalman_s0_agent_m0_readdatavalid;                                           // KALMAN_s0_translator:uav_readdatavalid -> KALMAN_s0_agent:m0_readdatavalid
	wire          kalman_s0_agent_m0_lock;                                                    // KALMAN_s0_agent:m0_lock -> KALMAN_s0_translator:uav_lock
	wire   [31:0] kalman_s0_agent_m0_writedata;                                               // KALMAN_s0_agent:m0_writedata -> KALMAN_s0_translator:uav_writedata
	wire          kalman_s0_agent_m0_write;                                                   // KALMAN_s0_agent:m0_write -> KALMAN_s0_translator:uav_write
	wire    [2:0] kalman_s0_agent_m0_burstcount;                                              // KALMAN_s0_agent:m0_burstcount -> KALMAN_s0_translator:uav_burstcount
	wire          kalman_s0_agent_rf_source_valid;                                            // KALMAN_s0_agent:rf_source_valid -> KALMAN_s0_agent_rsp_fifo:in_valid
	wire  [107:0] kalman_s0_agent_rf_source_data;                                             // KALMAN_s0_agent:rf_source_data -> KALMAN_s0_agent_rsp_fifo:in_data
	wire          kalman_s0_agent_rf_source_ready;                                            // KALMAN_s0_agent_rsp_fifo:in_ready -> KALMAN_s0_agent:rf_source_ready
	wire          kalman_s0_agent_rf_source_startofpacket;                                    // KALMAN_s0_agent:rf_source_startofpacket -> KALMAN_s0_agent_rsp_fifo:in_startofpacket
	wire          kalman_s0_agent_rf_source_endofpacket;                                      // KALMAN_s0_agent:rf_source_endofpacket -> KALMAN_s0_agent_rsp_fifo:in_endofpacket
	wire          kalman_s0_agent_rsp_fifo_out_valid;                                         // KALMAN_s0_agent_rsp_fifo:out_valid -> KALMAN_s0_agent:rf_sink_valid
	wire  [107:0] kalman_s0_agent_rsp_fifo_out_data;                                          // KALMAN_s0_agent_rsp_fifo:out_data -> KALMAN_s0_agent:rf_sink_data
	wire          kalman_s0_agent_rsp_fifo_out_ready;                                         // KALMAN_s0_agent:rf_sink_ready -> KALMAN_s0_agent_rsp_fifo:out_ready
	wire          kalman_s0_agent_rsp_fifo_out_startofpacket;                                 // KALMAN_s0_agent_rsp_fifo:out_startofpacket -> KALMAN_s0_agent:rf_sink_startofpacket
	wire          kalman_s0_agent_rsp_fifo_out_endofpacket;                                   // KALMAN_s0_agent_rsp_fifo:out_endofpacket -> KALMAN_s0_agent:rf_sink_endofpacket
	wire          cmd_mux_005_src_valid;                                                      // cmd_mux_005:src_valid -> KALMAN_s0_agent:cp_valid
	wire  [106:0] cmd_mux_005_src_data;                                                       // cmd_mux_005:src_data -> KALMAN_s0_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                      // KALMAN_s0_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [6:0] cmd_mux_005_src_channel;                                                    // cmd_mux_005:src_channel -> KALMAN_s0_agent:cp_channel
	wire          cmd_mux_005_src_startofpacket;                                              // cmd_mux_005:src_startofpacket -> KALMAN_s0_agent:cp_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                                // cmd_mux_005:src_endofpacket -> KALMAN_s0_agent:cp_endofpacket
	...
	wire  [106:0] nios_data_master_agent_cp_data;                                             // NIOS_data_master_agent:cp_data -> router:sink_data
	...
	wire  [106:0] nios_instruction_master_agent_cp_data;                                      // NIOS_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire  [106:0] nios_debug_mem_slave_agent_rp_data;                                         // NIOS_debug_mem_slave_agent:rp_data -> router_006:sink_data
	...
	wire          kalman_s0_agent_rp_valid;                                                   // KALMAN_s0_agent:rp_valid -> router_007:sink_valid
	wire  [106:0] kalman_s0_agent_rp_data;                                                    // KALMAN_s0_agent:rp_data -> router_007:sink_data
	wire          kalman_s0_agent_rp_ready;                                                   // router_007:sink_ready -> KALMAN_s0_agent:rp_ready
	wire          kalman_s0_agent_rp_startofpacket;                                           // KALMAN_s0_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          kalman_s0_agent_rp_endofpacket;                                             // KALMAN_s0_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire  [106:0] router_src_data;                                                            // router:src_data -> NIOS_data_master_limiter:cmd_sink_data
	wire          router_src_ready;                                                           // NIOS_data_master_limiter:cmd_sink_ready -> router:src_ready
	wire    [6:0] router_src_channel;                                                         // router:src_channel -> NIOS_data_master_limiter:cmd_sink_channel
	...
	wire  [106:0] nios_data_master_limiter_cmd_src_data;                                      // NIOS_data_master_limiter:cmd_src_data -> cmd_demux:sink_data
	wire          nios_data_master_limiter_cmd_src_ready;                                     // cmd_demux:sink_ready -> NIOS_data_master_limiter:cmd_src_ready
	wire    [6:0] nios_data_master_limiter_cmd_src_channel;                                   // NIOS_data_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire  [106:0] rsp_mux_src_data;                                                           // rsp_mux:src_data -> NIOS_data_master_limiter:rsp_sink_data
	wire          rsp_mux_src_ready;                                                          // NIOS_data_master_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire    [6:0] rsp_mux_src_channel;                                                        // rsp_mux:src_channel -> NIOS_data_master_limiter:rsp_sink_channel
	...
	wire  [106:0] nios_data_master_limiter_rsp_src_data;                                      // NIOS_data_master_limiter:rsp_src_data -> NIOS_data_master_agent:rp_data
	wire          nios_data_master_limiter_rsp_src_ready;                                     // NIOS_data_master_agent:rp_ready -> NIOS_data_master_limiter:rsp_src_ready
	wire    [6:0] nios_data_master_limiter_rsp_src_channel;                                   // NIOS_data_master_limiter:rsp_src_channel -> NIOS_data_master_agent:rp_channel
	...
	wire  [106:0] router_001_src_data;                                                        // router_001:src_data -> NIOS_instruction_master_limiter:cmd_sink_data
	wire          router_001_src_ready;                                                       // NIOS_instruction_master_limiter:cmd_sink_ready -> router_001:src_ready
	wire    [6:0] router_001_src_channel;                                                     // router_001:src_channel -> NIOS_instruction_master_limiter:cmd_sink_channel
	...
	wire  [106:0] nios_instruction_master_limiter_cmd_src_data;                               // NIOS_instruction_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire    [6:0] nios_instruction_master_limiter_cmd_src_channel;                            // NIOS_instruction_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire  [106:0] rsp_mux_001_src_data;                                                       // rsp_mux_001:src_data -> NIOS_instruction_master_limiter:rsp_sink_data
	wire          rsp_mux_001_src_ready;                                                      // NIOS_instruction_master_limiter:rsp_sink_ready -> rsp_mux_001:src_ready
	wire    [6:0] rsp_mux_001_src_channel;                                                    // rsp_mux_001:src_channel -> NIOS_instruction_master_limiter:rsp_sink_channel
	...
	wire  [106:0] nios_instruction_master_limiter_rsp_src_data;                               // NIOS_instruction_master_limiter:rsp_src_data -> NIOS_instruction_master_agent:rp_data
	...
	wire    [6:0] nios_instruction_master_limiter_rsp_src_channel;                            // NIOS_instruction_master_limiter:rsp_src_channel -> NIOS_instruction_master_agent:rp_channel
	...
	wire    [6:0] nios_data_master_limiter_cmd_valid_data;                                    // NIOS_data_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire    [6:0] nios_instruction_master_limiter_cmd_valid_data;                             // NIOS_instruction_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	...
	wire          kalman_s0_agent_rdata_fifo_src_valid;                                       // KALMAN_s0_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] kalman_s0_agent_rdata_fifo_src_data;                                        // KALMAN_s0_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire          kalman_s0_agent_rdata_fifo_src_ready;                                       // avalon_st_adapter_005:in_0_ready -> KALMAN_s0_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_005_out_0_valid;                                          // avalon_st_adapter_005:out_0_valid -> KALMAN_s0_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_005_out_0_data;                                           // avalon_st_adapter_005:out_0_data -> KALMAN_s0_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_005_out_0_ready;                                          // KALMAN_s0_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire    [0:0] avalon_st_adapter_005_out_0_error;                                          // avalon_st_adapter_005:out_0_error -> KALMAN_s0_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) kalman_s0_translator (
		.clk                    (SDRAM_PLL_c0_clk),                        //                      clk.clk
		.reset                  (DEBUG_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (kalman_s0_agent_m0_address),              // avalon_universal_slave_0.address
		.uav_burstcount         (kalman_s0_agent_m0_burstcount),           //                         .burstcount
		.uav_read               (kalman_s0_agent_m0_read),                 //                         .read
		.uav_write              (kalman_s0_agent_m0_write),                //                         .write
		.uav_waitrequest        (kalman_s0_agent_m0_waitrequest),          //                         .waitrequest
		.uav_readdatavalid      (kalman_s0_agent_m0_readdatavalid),        //                         .readdatavalid
		.uav_byteenable         (kalman_s0_agent_m0_byteenable),           //                         .byteenable
		.uav_readdata           (kalman_s0_agent_m0_readdata),             //                         .readdata
		.uav_writedata          (kalman_s0_agent_m0_writedata),            //                         .writedata
		.uav_lock               (kalman_s0_agent_m0_lock),                 //                         .lock
		.uav_debugaccess        (kalman_s0_agent_m0_debugaccess),          //                         .debugaccess
		.av_address             (KALMAN_s0_address),                       //      avalon_anti_slave_0.address
		.av_write               (KALMAN_s0_write),                         //                         .write
		.av_read                (KALMAN_s0_read),                          //                         .read
		.av_readdata            (KALMAN_s0_readdata),                      //                         .readdata
		.av_writedata           (KALMAN_s0_writedata),                     //                         .writedata
		.av_begintransfer       (),                                        //              (terminated)
		.av_beginbursttransfer  (),                                        //              (terminated)
		.av_burstcount          (),                                        //              (terminated)
		.av_byteenable          (),                                        //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (SDRAM_PLL_c0_clk),                           //             clk.clk
		.reset                   (DEBUG_reset_reset_bridge_in_reset_reset),    //       clk_reset.reset
		.m0_address              (kalman_s0_agent_m0_address),                 //              m0.address
		.m0_burstcount           (kalman_s0_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (kalman_s0_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (kalman_s0_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (kalman_s0_agent_m0_lock),                    //                .lock
		.m0_readdata             (kalman_s0_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (kalman_s0_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (kalman_s0_agent_m0_read),                    //                .read
		.m0_waitrequest          (kalman_s0_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (kalman_s0_agent_m0_writedata),               //                .writedata
		.m0_write                (kalman_s0_agent_m0_write),                   //                .write
		.rp_endofpacket          (kalman_s0_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (kalman_s0_agent_rp_ready),                   //                .ready
		.rp_valid                (kalman_s0_agent_rp_valid),                   //                .valid
		.rp_data                 (kalman_s0_agent_rp_data),                    //                .data
		.rp_startofpacket        (kalman_s0_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (kalman_s0_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (kalman_s0_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (kalman_s0_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (kalman_s0_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (kalman_s0_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (kalman_s0_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (kalman_s0_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (kalman_s0_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (kalman_s0_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (kalman_s0_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_005_out_0_ready),          // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_005_out_0_valid),          //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_005_out_0_data),           //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_005_out_0_error),          //                .error
		.rdata_fifo_src_ready    (kalman_s0_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (kalman_s0_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (kalman_s0_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                      //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                        //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) kalman_s0_agent_rsp_fifo (
		.clk               (SDRAM_PLL_c0_clk),                           //       clk.clk
		.reset             (DEBUG_reset_reset_bridge_in_reset_reset),    // clk_reset.reset
		.in_data           (kalman_s0_agent_rf_source_data),             //        in.data
		.in_valid          (kalman_s0_agent_rf_source_valid),            //          .valid
		.in_ready          (kalman_s0_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (kalman_s0_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (kalman_s0_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (kalman_s0_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (kalman_s0_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (kalman_s0_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (kalman_s0_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (kalman_s0_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                      // (terminated)
		.csr_read          (1'b0),                                       // (terminated)
		.csr_write         (1'b0),                                       // (terminated)
		.csr_readdata      (),                                           // (terminated)
	...
	kalman_interface_mm_interconnect_0_router router (
	...
	kalman_interface_mm_interconnect_0_router_001 router_001 (
	...
	kalman_interface_mm_interconnect_0_router_002 router_002 (
	...
	kalman_interface_mm_interconnect_0_router_002 router_003 (
	...
	kalman_interface_mm_interconnect_0_router_002 router_004 (
	...
	kalman_interface_mm_interconnect_0_router_002 router_005 (
	...
	kalman_interface_mm_interconnect_0_router_006 router_006 (
	...
	kalman_interface_mm_interconnect_0_router_002 router_007 (
		.sink_ready         (kalman_s0_agent_rp_ready),                //      sink.ready
		.sink_valid         (kalman_s0_agent_rp_valid),                //          .valid
		.sink_data          (kalman_s0_agent_rp_data),                 //          .data
		.sink_startofpacket (kalman_s0_agent_rp_startofpacket),        //          .startofpacket
		.sink_endofpacket   (kalman_s0_agent_rp_endofpacket),          //          .endofpacket
		.clk                (SDRAM_PLL_c0_clk),                        //       clk.clk
		.reset              (DEBUG_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	kalman_interface_mm_interconnect_0_router_008 router_008 (
	...
	kalman_interface_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (SDRAM_PLL_c0_clk),                               //        clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset),         //  clk_reset.reset
	...
	kalman_interface_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (SDRAM_PLL_c0_clk),                                      //        clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset),                //  clk_reset.reset
	...
	kalman_interface_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (SDRAM_PLL_c0_clk),                        //       clk.clk
		.reset               (DEBUG_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	kalman_interface_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (SDRAM_PLL_c0_clk),                        //       clk.clk
		.reset               (DEBUG_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	kalman_interface_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (SDRAM_PLL_c0_clk),                        //       clk.clk
		.reset               (DEBUG_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	kalman_interface_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (SDRAM_PLL_c0_clk),                        //       clk.clk
		.reset               (DEBUG_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	kalman_interface_mm_interconnect_0_cmd_mux_004 cmd_mux_004 (
		.clk                 (SDRAM_PLL_c0_clk),                       //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	kalman_interface_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (SDRAM_PLL_c0_clk),                        //       clk.clk
		.reset               (DEBUG_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	kalman_interface_mm_interconnect_0_cmd_mux_004 cmd_mux_006 (
		.clk                 (SDRAM_PLL_c0_clk),                        //       clk.clk
		.reset               (DEBUG_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	kalman_interface_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (SDRAM_PLL_c0_clk),                        //       clk.clk
		.reset              (DEBUG_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	kalman_interface_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (SDRAM_PLL_c0_clk),                        //       clk.clk
		.reset              (DEBUG_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	kalman_interface_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (SDRAM_PLL_c0_clk),                        //       clk.clk
		.reset              (DEBUG_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	kalman_interface_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (SDRAM_PLL_c0_clk),                        //       clk.clk
		.reset              (DEBUG_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	kalman_interface_mm_interconnect_0_rsp_demux_004 rsp_demux_004 (
		.clk                (SDRAM_PLL_c0_clk),                       //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	kalman_interface_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (SDRAM_PLL_c0_clk),                        //       clk.clk
		.reset              (DEBUG_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	kalman_interface_mm_interconnect_0_rsp_demux_004 rsp_demux_006 (
		.clk                (SDRAM_PLL_c0_clk),                             //       clk.clk
		.reset              (DEBUG_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
	...
	kalman_interface_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (SDRAM_PLL_c0_clk),                       //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	kalman_interface_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (SDRAM_PLL_c0_clk),                       //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	kalman_interface_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	kalman_interface_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (SDRAM_PLL_c0_clk),                        // in_clk_0.clk
		.in_rst_0_reset (DEBUG_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (kalman_s0_agent_rdata_fifo_src_data),     //     in_0.data
		.in_0_valid     (kalman_s0_agent_rdata_fifo_src_valid),    //         .valid
		.in_0_ready     (kalman_s0_agent_rdata_fifo_src_ready),    //         .ready
	...
	kalman_interface_mm_interconnect_0_avalon_st_adapter_006 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
