// nios_interface_mm_interconnect_1.v
...
`timescale 1 ps / 1 ps
module nios_interface_mm_interconnect_1 (
	...
	wire  [80:0] led_pio_s1_agent_rf_source_data;                                         // led_pio_s1_agent:rf_source_data -> led_pio_s1_agent_rsp_fifo:in_data
	...
	wire  [80:0] led_pio_s1_agent_rsp_fifo_out_data;                                      // led_pio_s1_agent_rsp_fifo:out_data -> led_pio_s1_agent:rf_sink_data
	...
	wire  [79:0] cmd_mux_src_data;                                                        // cmd_mux:src_data -> led_pio_s1_agent:cp_data
	wire         cmd_mux_src_ready;                                                       // led_pio_s1_agent:cp_ready -> cmd_mux:src_ready
	wire   [1:0] cmd_mux_src_channel;                                                     // cmd_mux:src_channel -> led_pio_s1_agent:cp_channel
	...
	wire  [80:0] button_pio_s1_agent_rf_source_data;                                      // button_pio_s1_agent:rf_source_data -> button_pio_s1_agent_rsp_fifo:in_data
	...
	wire  [80:0] button_pio_s1_agent_rsp_fifo_out_data;                                   // button_pio_s1_agent_rsp_fifo:out_data -> button_pio_s1_agent:rf_sink_data
	...
	wire  [79:0] cmd_mux_001_src_data;                                                    // cmd_mux_001:src_data -> button_pio_s1_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                   // button_pio_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [1:0] cmd_mux_001_src_channel;                                                 // cmd_mux_001:src_channel -> button_pio_s1_agent:cp_channel
	...
	wire  [79:0] peripheral_bridge_m0_agent_cp_data;                                      // peripheral_bridge_m0_agent:cp_data -> router:sink_data
	...
	wire  [79:0] led_pio_s1_agent_rp_data;                                                // led_pio_s1_agent:rp_data -> router_001:sink_data
	...
	wire  [79:0] button_pio_s1_agent_rp_data;                                             // button_pio_s1_agent:rp_data -> router_002:sink_data
	...
	wire  [79:0] router_src_data;                                                         // router:src_data -> peripheral_bridge_m0_limiter:cmd_sink_data
	...
	wire  [79:0] peripheral_bridge_m0_limiter_cmd_src_data;                               // peripheral_bridge_m0_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [79:0] rsp_mux_src_data;                                                        // rsp_mux:src_data -> peripheral_bridge_m0_limiter:rsp_sink_data
	...
	wire  [79:0] peripheral_bridge_m0_limiter_rsp_src_data;                               // peripheral_bridge_m0_limiter:rsp_src_data -> peripheral_bridge_m0_agent:rp_data
	...
	wire         button_pio_s1_agent_rdata_fifo_src_valid;                                // button_pio_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] button_pio_s1_agent_rdata_fifo_src_data;                                 // button_pio_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         button_pio_s1_agent_rdata_fifo_src_ready;                                // avalon_st_adapter_001:in_0_ready -> button_pio_s1_agent:rdata_fifo_src_ready
	...
	nios_interface_mm_interconnect_1_router router (
	...
	nios_interface_mm_interconnect_1_router_001 router_001 (
	...
	nios_interface_mm_interconnect_1_router_001 router_002 (
	...
	nios_interface_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                       //        clk.clk
		.reset              (peripheral_bridge_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	nios_interface_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                       //       clk.clk
		.reset               (peripheral_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_interface_mm_interconnect_1_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                       //       clk.clk
		.reset               (peripheral_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_interface_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                       //       clk.clk
		.reset              (peripheral_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_interface_mm_interconnect_1_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                       //       clk.clk
		.reset              (peripheral_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_interface_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                       //       clk.clk
		.reset               (peripheral_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
