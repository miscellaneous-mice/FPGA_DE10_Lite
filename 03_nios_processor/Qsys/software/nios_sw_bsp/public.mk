...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../nios_interface.sopcinfo
...
# Design Name 
# setting SOPC_NAME is nios_interface
SOPC_NAME := nios_interface
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1041000
SOPC_SYSID_FLAG += --sidp=0x1041000
ELF_PATCH_FLAG  += --sidp 0x1041000

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1772624077
SOPC_SYSID_FLAG += --timestamp=1772624077
ELF_PATCH_FLAG  += --timestamp 1772624077
