// avalon_design_io_peripherals_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module avalon_design_io_peripherals_mm_interconnect_0 (
		...
		output wire [1:0]  counter_s0_address,                                  //                                    counter_s0.address
		output wire        counter_s0_write,                                    //                                              .write
		output wire        counter_s0_read,                                     //                                              .read
		input  wire [31:0] counter_s0_readdata,                                 //                                              .readdata
		output wire [31:0] counter_s0_writedata,                                //                                              .writedata
	...
	wire         cmd_mux_src_valid;                                                       // cmd_mux:src_valid -> hex_display_s0_agent:cp_valid
	wire  [81:0] cmd_mux_src_data;                                                        // cmd_mux:src_data -> hex_display_s0_agent:cp_data
	wire         cmd_mux_src_ready;                                                       // hex_display_s0_agent:cp_ready -> cmd_mux:src_ready
	wire   [3:0] cmd_mux_src_channel;                                                     // cmd_mux:src_channel -> hex_display_s0_agent:cp_channel
	wire         cmd_mux_src_startofpacket;                                               // cmd_mux:src_startofpacket -> hex_display_s0_agent:cp_startofpacket
	wire         cmd_mux_src_endofpacket;                                                 // cmd_mux:src_endofpacket -> hex_display_s0_agent:cp_endofpacket
	wire  [31:0] counter_s0_agent_m0_readdata;                                            // counter_s0_translator:uav_readdata -> counter_s0_agent:m0_readdata
	wire         counter_s0_agent_m0_waitrequest;                                         // counter_s0_translator:uav_waitrequest -> counter_s0_agent:m0_waitrequest
	wire         counter_s0_agent_m0_debugaccess;                                         // counter_s0_agent:m0_debugaccess -> counter_s0_translator:uav_debugaccess
	wire   [9:0] counter_s0_agent_m0_address;                                             // counter_s0_agent:m0_address -> counter_s0_translator:uav_address
	wire   [3:0] counter_s0_agent_m0_byteenable;                                          // counter_s0_agent:m0_byteenable -> counter_s0_translator:uav_byteenable
	wire         counter_s0_agent_m0_read;                                                // counter_s0_agent:m0_read -> counter_s0_translator:uav_read
	wire         counter_s0_agent_m0_readdatavalid;                                       // counter_s0_translator:uav_readdatavalid -> counter_s0_agent:m0_readdatavalid
	wire         counter_s0_agent_m0_lock;                                                // counter_s0_agent:m0_lock -> counter_s0_translator:uav_lock
	wire  [31:0] counter_s0_agent_m0_writedata;                                           // counter_s0_agent:m0_writedata -> counter_s0_translator:uav_writedata
	wire         counter_s0_agent_m0_write;                                               // counter_s0_agent:m0_write -> counter_s0_translator:uav_write
	wire   [2:0] counter_s0_agent_m0_burstcount;                                          // counter_s0_agent:m0_burstcount -> counter_s0_translator:uav_burstcount
	wire         counter_s0_agent_rf_source_valid;                                        // counter_s0_agent:rf_source_valid -> counter_s0_agent_rsp_fifo:in_valid
	wire  [82:0] counter_s0_agent_rf_source_data;                                         // counter_s0_agent:rf_source_data -> counter_s0_agent_rsp_fifo:in_data
	wire         counter_s0_agent_rf_source_ready;                                        // counter_s0_agent_rsp_fifo:in_ready -> counter_s0_agent:rf_source_ready
	wire         counter_s0_agent_rf_source_startofpacket;                                // counter_s0_agent:rf_source_startofpacket -> counter_s0_agent_rsp_fifo:in_startofpacket
	wire         counter_s0_agent_rf_source_endofpacket;                                  // counter_s0_agent:rf_source_endofpacket -> counter_s0_agent_rsp_fifo:in_endofpacket
	wire         counter_s0_agent_rsp_fifo_out_valid;                                     // counter_s0_agent_rsp_fifo:out_valid -> counter_s0_agent:rf_sink_valid
	wire  [82:0] counter_s0_agent_rsp_fifo_out_data;                                      // counter_s0_agent_rsp_fifo:out_data -> counter_s0_agent:rf_sink_data
	wire         counter_s0_agent_rsp_fifo_out_ready;                                     // counter_s0_agent:rf_sink_ready -> counter_s0_agent_rsp_fifo:out_ready
	wire         counter_s0_agent_rsp_fifo_out_startofpacket;                             // counter_s0_agent_rsp_fifo:out_startofpacket -> counter_s0_agent:rf_sink_startofpacket
	wire         counter_s0_agent_rsp_fifo_out_endofpacket;                               // counter_s0_agent_rsp_fifo:out_endofpacket -> counter_s0_agent:rf_sink_endofpacket
	wire         cmd_mux_001_src_valid;                                                   // cmd_mux_001:src_valid -> counter_s0_agent:cp_valid
	wire  [81:0] cmd_mux_001_src_data;                                                    // cmd_mux_001:src_data -> counter_s0_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                   // counter_s0_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [3:0] cmd_mux_001_src_channel;                                                 // cmd_mux_001:src_channel -> counter_s0_agent:cp_channel
	wire         cmd_mux_001_src_startofpacket;                                           // cmd_mux_001:src_startofpacket -> counter_s0_agent:cp_startofpacket
	wire         cmd_mux_001_src_endofpacket;                                             // cmd_mux_001:src_endofpacket -> counter_s0_agent:cp_endofpacket
	...
	wire  [81:0] cmd_mux_002_src_data;                                                    // cmd_mux_002:src_data -> led_pio_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                   // led_pio_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [3:0] cmd_mux_002_src_channel;                                                 // cmd_mux_002:src_channel -> led_pio_s1_agent:cp_channel
	...
	wire   [9:0] button_pio_s1_agent_m0_address;                                          // button_pio_s1_agent:m0_address -> button_pio_s1_translator:uav_address
	...
	wire  [81:0] cmd_mux_003_src_data;                                                    // cmd_mux_003:src_data -> button_pio_s1_agent:cp_data
	...
	wire         hex_display_s0_agent_rp_valid;                                           // hex_display_s0_agent:rp_valid -> router_001:sink_valid
	wire  [81:0] hex_display_s0_agent_rp_data;                                            // hex_display_s0_agent:rp_data -> router_001:sink_data
	wire         hex_display_s0_agent_rp_ready;                                           // router_001:sink_ready -> hex_display_s0_agent:rp_ready
	wire         hex_display_s0_agent_rp_startofpacket;                                   // hex_display_s0_agent:rp_startofpacket -> router_001:sink_startofpacket
	wire         hex_display_s0_agent_rp_endofpacket;                                     // hex_display_s0_agent:rp_endofpacket -> router_001:sink_endofpacket
	...
	wire         counter_s0_agent_rp_valid;                                               // counter_s0_agent:rp_valid -> router_002:sink_valid
	wire  [81:0] counter_s0_agent_rp_data;                                                // counter_s0_agent:rp_data -> router_002:sink_data
	wire         counter_s0_agent_rp_ready;                                               // router_002:sink_ready -> counter_s0_agent:rp_ready
	wire         counter_s0_agent_rp_startofpacket;                                       // counter_s0_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire         counter_s0_agent_rp_endofpacket;                                         // counter_s0_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire  [81:0] led_pio_s1_agent_rp_data;                                                // led_pio_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [81:0] button_pio_s1_agent_rp_data;                                             // button_pio_s1_agent:rp_data -> router_004:sink_data
	...
	wire         hex_display_s0_agent_rdata_fifo_src_valid;                               // hex_display_s0_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire  [33:0] hex_display_s0_agent_rdata_fifo_src_data;                                // hex_display_s0_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire         hex_display_s0_agent_rdata_fifo_src_ready;                               // avalon_st_adapter:in_0_ready -> hex_display_s0_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_out_0_valid;                                           // avalon_st_adapter:out_0_valid -> hex_display_s0_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_out_0_data;                                            // avalon_st_adapter:out_0_data -> hex_display_s0_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_out_0_ready;                                           // hex_display_s0_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire   [0:0] avalon_st_adapter_out_0_error;                                           // avalon_st_adapter:out_0_error -> hex_display_s0_agent:rdata_fifo_sink_error
	wire         counter_s0_agent_rdata_fifo_src_valid;                                   // counter_s0_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] counter_s0_agent_rdata_fifo_src_data;                                    // counter_s0_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         counter_s0_agent_rdata_fifo_src_ready;                                   // avalon_st_adapter_001:in_0_ready -> counter_s0_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_001_out_0_valid;                                       // avalon_st_adapter_001:out_0_valid -> counter_s0_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_001_out_0_data;                                        // avalon_st_adapter_001:out_0_data -> counter_s0_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                       // counter_s0_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                       // avalon_st_adapter_001:out_0_error -> counter_s0_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) counter_s0_translator (
		.clk                    (clock_bridge_out_clk_clk),                            //                      clk.clk
		.reset                  (peripheral_bridge_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (counter_s0_agent_m0_address),                         // avalon_universal_slave_0.address
		.uav_burstcount         (counter_s0_agent_m0_burstcount),                      //                         .burstcount
		.uav_read               (counter_s0_agent_m0_read),                            //                         .read
		.uav_write              (counter_s0_agent_m0_write),                           //                         .write
		.uav_waitrequest        (counter_s0_agent_m0_waitrequest),                     //                         .waitrequest
		.uav_readdatavalid      (counter_s0_agent_m0_readdatavalid),                   //                         .readdatavalid
		.uav_byteenable         (counter_s0_agent_m0_byteenable),                      //                         .byteenable
		.uav_readdata           (counter_s0_agent_m0_readdata),                        //                         .readdata
		.uav_writedata          (counter_s0_agent_m0_writedata),                       //                         .writedata
		.uav_lock               (counter_s0_agent_m0_lock),                            //                         .lock
		.uav_debugaccess        (counter_s0_agent_m0_debugaccess),                     //                         .debugaccess
		.av_address             (counter_s0_address),                                  //      avalon_anti_slave_0.address
		.av_write               (counter_s0_write),                                    //                         .write
		.av_read                (counter_s0_read),                                     //                         .read
		.av_readdata            (counter_s0_readdata),                                 //                         .readdata
		.av_writedata           (counter_s0_writedata),                                //                         .writedata
		.av_begintransfer       (),                                                    //              (terminated)
		.av_beginbursttransfer  (),                                                    //              (terminated)
		.av_burstcount          (),                                                    //              (terminated)
		.av_byteenable          (),                                                    //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clock_bridge_out_clk_clk),                            //             clk.clk
		.reset                   (peripheral_bridge_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (counter_s0_agent_m0_address),                         //              m0.address
		.m0_burstcount           (counter_s0_agent_m0_burstcount),                      //                .burstcount
		.m0_byteenable           (counter_s0_agent_m0_byteenable),                      //                .byteenable
		.m0_debugaccess          (counter_s0_agent_m0_debugaccess),                     //                .debugaccess
		.m0_lock                 (counter_s0_agent_m0_lock),                            //                .lock
		.m0_readdata             (counter_s0_agent_m0_readdata),                        //                .readdata
		.m0_readdatavalid        (counter_s0_agent_m0_readdatavalid),                   //                .readdatavalid
		.m0_read                 (counter_s0_agent_m0_read),                            //                .read
		.m0_waitrequest          (counter_s0_agent_m0_waitrequest),                     //                .waitrequest
		.m0_writedata            (counter_s0_agent_m0_writedata),                       //                .writedata
		.m0_write                (counter_s0_agent_m0_write),                           //                .write
		.rp_endofpacket          (counter_s0_agent_rp_endofpacket),                     //              rp.endofpacket
		.rp_ready                (counter_s0_agent_rp_ready),                           //                .ready
		.rp_valid                (counter_s0_agent_rp_valid),                           //                .valid
		.rp_data                 (counter_s0_agent_rp_data),                            //                .data
		.rp_startofpacket        (counter_s0_agent_rp_startofpacket),                   //                .startofpacket
		...
		.rf_sink_ready           (counter_s0_agent_rsp_fifo_out_ready),                 //         rf_sink.ready
		.rf_sink_valid           (counter_s0_agent_rsp_fifo_out_valid),                 //                .valid
		.rf_sink_startofpacket   (counter_s0_agent_rsp_fifo_out_startofpacket),         //                .startofpacket
		.rf_sink_endofpacket     (counter_s0_agent_rsp_fifo_out_endofpacket),           //                .endofpacket
		.rf_sink_data            (counter_s0_agent_rsp_fifo_out_data),                  //                .data
		.rf_source_ready         (counter_s0_agent_rf_source_ready),                    //       rf_source.ready
		.rf_source_valid         (counter_s0_agent_rf_source_valid),                    //                .valid
		.rf_source_startofpacket (counter_s0_agent_rf_source_startofpacket),            //                .startofpacket
		.rf_source_endofpacket   (counter_s0_agent_rf_source_endofpacket),              //                .endofpacket
		.rf_source_data          (counter_s0_agent_rf_source_data),                     //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_001_out_0_ready),                   // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_001_out_0_valid),                   //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_001_out_0_data),                    //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_001_out_0_error),                   //                .error
		.rdata_fifo_src_ready    (counter_s0_agent_rdata_fifo_src_ready),               //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (counter_s0_agent_rdata_fifo_src_valid),               //                .valid
		.rdata_fifo_src_data     (counter_s0_agent_rdata_fifo_src_data),                //                .data
		.m0_response             (2'b00),                                               //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                 //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) counter_s0_agent_rsp_fifo (
		.clk               (clock_bridge_out_clk_clk),                            //       clk.clk
		.reset             (peripheral_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (counter_s0_agent_rf_source_data),                     //        in.data
		.in_valid          (counter_s0_agent_rf_source_valid),                    //          .valid
		.in_ready          (counter_s0_agent_rf_source_ready),                    //          .ready
		.in_startofpacket  (counter_s0_agent_rf_source_startofpacket),            //          .startofpacket
		.in_endofpacket    (counter_s0_agent_rf_source_endofpacket),              //          .endofpacket
		.out_data          (counter_s0_agent_rsp_fifo_out_data),                  //       out.data
		.out_valid         (counter_s0_agent_rsp_fifo_out_valid),                 //          .valid
		.out_ready         (counter_s0_agent_rsp_fifo_out_ready),                 //          .ready
		.out_startofpacket (counter_s0_agent_rsp_fifo_out_startofpacket),         //          .startofpacket
		.out_endofpacket   (counter_s0_agent_rsp_fifo_out_endofpacket),           //          .endofpacket
		.csr_address       (2'b00),                                               // (terminated)
		.csr_read          (1'b0),                                                // (terminated)
		.csr_write         (1'b0),                                                // (terminated)
		.csr_readdata      (),                                                    // (terminated)
	...
	avalon_design_io_peripherals_mm_interconnect_0_router router (
	...
	avalon_design_io_peripherals_mm_interconnect_0_router_001 router_001 (
	...
	avalon_design_io_peripherals_mm_interconnect_0_router_001 router_002 (
		.sink_ready         (counter_s0_agent_rp_ready),                           //      sink.ready
		.sink_valid         (counter_s0_agent_rp_valid),                           //          .valid
		.sink_data          (counter_s0_agent_rp_data),                            //          .data
		.sink_startofpacket (counter_s0_agent_rp_startofpacket),                   //          .startofpacket
		.sink_endofpacket   (counter_s0_agent_rp_endofpacket),                     //          .endofpacket
		.clk                (clock_bridge_out_clk_clk),                            //       clk.clk
		.reset              (peripheral_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	avalon_design_io_peripherals_mm_interconnect_0_router_001 router_003 (
	...
	avalon_design_io_peripherals_mm_interconnect_0_router_001 router_004 (
	...
	avalon_design_io_peripherals_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clock_bridge_out_clk_clk),                            //        clk.clk
		.reset              (peripheral_bridge_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	avalon_design_io_peripherals_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clock_bridge_out_clk_clk),                            //       clk.clk
		.reset               (peripheral_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	avalon_design_io_peripherals_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clock_bridge_out_clk_clk),                            //       clk.clk
		.reset               (peripheral_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	avalon_design_io_peripherals_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clock_bridge_out_clk_clk),                            //       clk.clk
		.reset               (peripheral_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	avalon_design_io_peripherals_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clock_bridge_out_clk_clk),                            //       clk.clk
		.reset               (peripheral_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	avalon_design_io_peripherals_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clock_bridge_out_clk_clk),                            //       clk.clk
		.reset              (peripheral_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	avalon_design_io_peripherals_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clock_bridge_out_clk_clk),                            //       clk.clk
		.reset              (peripheral_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	avalon_design_io_peripherals_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clock_bridge_out_clk_clk),                            //       clk.clk
		.reset              (peripheral_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	avalon_design_io_peripherals_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clock_bridge_out_clk_clk),                            //       clk.clk
		.reset              (peripheral_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	avalon_design_io_peripherals_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clock_bridge_out_clk_clk),                            //       clk.clk
		.reset               (peripheral_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	avalon_design_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clock_bridge_out_clk_clk),                            // in_clk_0.clk
		.in_rst_0_reset (peripheral_bridge_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (counter_s0_agent_rdata_fifo_src_data),                //     in_0.data
		.in_0_valid     (counter_s0_agent_rdata_fifo_src_valid),               //         .valid
		.in_0_ready     (counter_s0_agent_rdata_fifo_src_ready),               //         .ready
