...
# Memory: mem_sys_subsystem_SRAM
MEM_0 := avalon_design_mem_sys_subsystem_SRAM
$(MEM_0)_NAME := mem_sys_subsystem_SRAM
...
$(MEM_0)_HIERARCHICAL_PATH := mem_sys_subsystem.SRAM
$(MEM_0)_WIDTH := 32
$(MEM_0)_HEX_DATA_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: mem_sys_subsystem_SRAM
mem_sys_subsystem_SRAM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
