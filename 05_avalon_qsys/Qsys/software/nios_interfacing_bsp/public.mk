...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../avalon_design.sopcinfo
...
# Design Name 
# setting SOPC_NAME is avalon_design
SOPC_NAME := avalon_design
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x41400
SOPC_SYSID_FLAG += --sidp=0x41400
ELF_PATCH_FLAG  += --sidp 0x41400

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1772633514
SOPC_SYSID_FLAG += --timestamp=1772633514
ELF_PATCH_FLAG  += --timestamp 1772633514
...
# setting hal.stderr is mem_sys_subsystem_DEBUG
ELF_PATCH_FLAG  += --stderr_dev mem_sys_subsystem_DEBUG

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is mem_sys_subsystem_DEBUG
ELF_PATCH_FLAG  += --stdin_dev mem_sys_subsystem_DEBUG
...
# setting hal.stdout is mem_sys_subsystem_DEBUG
ELF_PATCH_FLAG  += --stdout_dev mem_sys_subsystem_DEBUG
