...
module avalon_design_io_interface_mm_interconnect_0_router_default_decode
  #(
...
module avalon_design_io_interface_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    avalon_design_io_interface_mm_interconnect_0_router_default_decode the_default_decode(
